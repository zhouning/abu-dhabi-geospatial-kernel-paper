...
| External product diagnostic | Materialized and hashed ESA WorldCover 2020 v1.0 and 2021 v2.0 built-fraction rasters at the benchmark grid; compared built stock and built gain across thresholds 0.05–0.30. | The former Dynamic World-count built-gain result is now identified as structural-zero and zero-powered because built count declines. The new WorldCover-count action gives Kernel F1 0.0157–0.0397 versus random 0.0251–0.0277; Kernel is higher only at thresholds 0.20 and 0.30. Dynamic World-to-WorldCover gain F1 remains 0.0111–0.0192 as evidence of product disagreement. |
...
| Informative external allocation test was missing | Added a WorldCover-count action: for every threshold, the 2020-origin, road-free Kernel proposal ranks mutable non-built cells; random allocation uses the same candidates and count. | Kernel F1 is 0.0157, 0.0228, 0.0268 and 0.0397; random F1 is 0.0268, 0.0277, 0.0251 and 0.0251. This mixed result is product agreement, not authoritative validation. |
